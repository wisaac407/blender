...
static void rna_def_modifier_setsplitnormal(BlenderRNA *brna)
{
	...
	static EnumPropertyItem prop_mode_items[] = {
		...
		{MOD_SETSPLITNORMAL_BOX, "BOX", 0, "Box", "From a rectangular box"},
		{MOD_SETSPLITNORMAL_ELLIPSOID, "ELLIPSOID", 0, "Ellipsoid", "From an ellipsoid"},
		{0, NULL, 0, NULL, NULL}
	};
	...
	RNA_def_property_ui_text(prop, "Object", "Mesh object to take normals from");
	...
	RNA_def_property_ui_text(prop, "BoundingBox Center",
	                         "Center box or ellipsoid on bounding box center instead of own object center");
	RNA_def_property_update(prop, 0, "rna_Modifier_update");

	prop = RNA_def_property(srna, "object_center", PROP_POINTER, PROP_NONE);
	RNA_def_property_ui_text(prop, "Object Center",
	                         "Center box or ellipsoid on this object center (overrides BoundingBox Center when set)");
