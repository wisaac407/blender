...
typedef struct RenderEngineType {
	...
	void (*bake)(struct RenderEngine *engine, struct Scene *scene, struct Object *object, const int pass_type, const struct BakePixel *pixel_array, const int width, const int height, const int depth, void *result);
